...
namespace Zuperdukkan.Nhibernate
{
    public class NhibernateHelper
    {
        ...
        private static ISessionFactory SessionFactory
        {
            get
            {
                if (_sessionFactory == null)
                {
                    ...
                    configuration.AddDeserializedMapping(mapping, "zuperDukkan");
        ...
        public static Configuration ConfigureNhibernate()
        {
            ...
            configure.DataBaseIntegration(db =>
            {
                ...
                db.ConnectionString = "Data Source=DESKTOP-AJ03L4H\\SQLEXPRESS;Initial Catalog=zuperDukkan;Integrated Security=True";
